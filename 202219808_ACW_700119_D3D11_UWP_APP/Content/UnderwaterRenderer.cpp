...
UnderwaterRenderer::UnderwaterRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void UnderwaterRenderer::CreateWindowSizeDependentResources()
{
...
void UnderwaterRenderer::CreateDeviceDependentResources()
{
...
void UnderwaterRenderer::ReleaseDeviceDependentResources()
{
	m_loadingComplete = false;
...
void UnderwaterRenderer::Update(DX::StepTimer const& timer)
{
