...
FishRenderer::FishRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void FishRenderer::CreateWindowSizeDependentResources()
{
...
void FishRenderer::CreateDeviceDependentResources()
{
	// Load shaders asynchronously.
	auto loadVSTask = DX::ReadDataAsync(L"VertexShader08.cso");
	auto loadGSTask = DX::ReadDataAsync(L"GeometryShader08.cso");
	auto loadPSTask = DX::ReadDataAsync(L"PixelShader08.cso");
...
void FishRenderer::ReleaseDeviceDependentResources()
{
	m_loadingComplete = false;
...
void FishRenderer::Update(DX::StepTimer const& timer)
{
